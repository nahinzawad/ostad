                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="text" name="title"
                                    ...
                                    placeholder="" value="<?php echo e(old('title',$post->title)); ?>" />
                            </label>
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="text" name="slug"
                                    class="block w-full mt-1 rounded-md"
                                    placeholder="" value="<?php echo e(old('slug',$post->slug)); ?>" />
                            </label>
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <textarea id="editor" class="block w-full mt-1 rounded-md" name="content"
                                    rows="3"><?php echo e($post->content); ?></textarea>
                            </label>
...
<?php endif; ?><?php /**PATH /Users/shahriashormee/Desktop/test-git/laravelCURDtailwindcss/resources/views/posts/edit.blade.php ENDPATH**/ ?>