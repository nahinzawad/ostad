...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="number" name="price" class="block w-full mt-1 rounded-md" placeholder=""
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <textarea id="editor" class="block w-full mt-1 rounded-md" name="content" rows="3"><?php echo e(old('content')); ?></textarea>
                            </label>
...
<?php endif; ?><?php /**PATH /Users/shahriashormee/Desktop/test-git/laravelCURDtailwindcss/resources/views/products/create.blade.php ENDPATH**/ ?>